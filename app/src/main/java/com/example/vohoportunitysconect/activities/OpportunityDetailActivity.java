...
public class OpportunityDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbRef = FirebaseDatabase.getInstance("https://vvoohh-e2b0a-default-rtdb.firebaseio.com").getReference();

        // Get opportunity ID from intent
        opportunityId = getIntent().getStringExtra("opportunityId");
        if (opportunityId == null) {
            Toast.makeText(this, "Error: Opportunity ID not found", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
        ...
        dbRef.child("opportunities").child(opportunityId)
            .addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        Toast.makeText(OpportunityDetailActivity.this, 
                            "Opportunity not found", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
                ...
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(OpportunityDetailActivity.this, 
                        "Error loading opportunity: " + databaseError.getMessage(), 
